...
SECURITY_PREFLIGHT_PUBLIC_BASE_URL="${SECURITY_PREFLIGHT_PUBLIC_BASE_URL:-http://docker.home.cz:8780}"
SECURITY_PREFLIGHT_CORS_ORIGINS="${SECURITY_PREFLIGHT_CORS_ORIGINS:-http://docker.home.cz:8780,http://localhost:8780,http://127.0.0.1:8780}"
