...
SECURITY_PREFLIGHT_REDIRECT_URIS="${SECURITY_PREFLIGHT_REDIRECT_URIS:-[\"$SECURITY_PREFLIGHT_PUBLIC_BASE_URL/*\",\"http://docker.home.cz:8780/*\",\"http://localhost:8780/*\",\"http://127.0.0.1:8780/*\",\"https://securitypreflight.zeleznalady.cz/*\",\"https://security-preflight.zeleznalady.cz/*\"]}"
