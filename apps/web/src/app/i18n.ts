...
export const uiText = {
  cs: {
    ...
    dashboard: {
      ...
      reportsEvidenceDetail: (ready: number, total: number) => `${ready}/${total} reportových artefaktů je dostupných z posledního běhu.`,
      projects: "Projekty",
    ...
    projects: {
      ...
      publicUrlSaved: (name: string) => `Veřejná URL projektu ${name} byla uložena.`,
      publicUrlSaveFailed: "Veřejnou URL projektu se nepodařilo uložit.",
    ...
    execution: {
      ...
      exportCodexLabel: "Exportovat balík pro Codex",
      exportCodexTitle: "Export redigovaného Markdown zadání pro Codex",
      ...
      reportCenter: "Reporty",
      reportCenterAria: "Reportové centrum posledního skenu",
      reportRunMissing: "Spusťte nebo načtěte sken pro vytvoření reportové evidence.",
      markdownReport: "Markdown report",
      jsonReport: "JSON report",
      sarifReport: "SARIF report",
      centralEnvelope: "Centrální výsledková obálka",
      deliveryManifest: "Manifest doručení",
      reportReady: "připraveno",
      reportMissing: "chybí",
      reportEvidenceMeta: (root: string, fileName: string) => `${root}/${fileName}`,
      reportEvidenceMissingMeta: "čeká na další dokončený běh",
    ...
    telemetry: {
      ...
      accessDescription: "STRATOS OIDC, capabilities a aktivní scopes",
      signIn: "Přihlásit",
      signOut: "Odhlásit",
      apiAuthMode: "Režim autentizace API",
      sharedTokenOrLocal: "shared token nebo lokální vývoj",
      rbacRoles: "Diagnostické identity role",
      operatorRoles: (count: number) => `${count} zobrazovaných rolí`,
      notLoaded: "nenačteno",
    ...
    auth: {
      ...
      accessDenied: "Bez oprávnění",
      accessDeniedTopbar: "SecurityPreflight / Bez oprávnění",
    ...
    messages: {
      ...
      activeProfileSwitchedToWebTarget: "Tento profil kontroluje běžící web nebo API. Přepnul jsem cíl na Web/API; doplňte URL aplikace a spusťte sken.",
      activeProfileSwitchedToSavedWebTarget: "Tento profil kontroluje běžící web nebo API. Přepnul jsem cíl na Web/API a použil uloženou URL projektu.",
      ...
      codexInitial: "Balík pro Codex vznikne z redigované evidence posledního skenu.",
      generatingCodex: "Generuji redigovaný Markdown balík pro Codex...",
      codexGenerated: (fileName: string) => `Balík pro Codex vytvořen: ${fileName}`,
      codexFailed: "Export balíku pro Codex selhal.",
      loadProfilesFallback: "Načtěte profily z lokálního API pro zahájení skenování."
    },
    newScan: {
      title: "Nová bezpečnostní kontrola",
      subtitle: "Zvolte adresář projektu nebo povolenou URL, vyberte profil, spusťte plán nebo scan a stáhněte výstup pro opravu v Codexu.",
      workflow: "Průchod kontrolou",
      workflowDescription: "Cíl, profil, plán, evidence a následná oprava zůstávají v jednom pracovním toku.",
      noRun: "bez běhu",
      target: "Cíl kontroly",
      selectedTarget: "Vybraný cíl",
      scanComposer: "Nastavit kontrolu",
      scanControl: "Profil a spuštění",
      projectRegistry: "Registrovat adresář",
      projectRegistryDescription: "Ruční registrace je doplněk k automatickému načítání /srv a /opt.",
      latestOutcome: "Poslední výsledek",
      liveProgress: "Živý průběh",
      readyToRun: "připraveno",
      runningNow: "běží",
      lastRun: "stav",
      codexPackage: "Codex remediation",
      exportCodex: "Balík pro Codex",
      redactedMarkdown: "Redigovaný Markdown",
      codexMeta: "Prompt, prioritní nálezy, validace, evidence a bezpečnostní omezení.",
      evidence: "Evidence",
      stepTarget: "1. Cíl",
      stepProfile: "2. Profil",
      stepPlan: "3. Plán a spuštění",
      stepCodex: "4. Oprava v Codexu",
      profileChecks: (count: number) => `${count} kontrol`,
      planPending: "Dry-run plán ještě nebyl sestaven.",
    ...
    runPanel: {
      ...
      savedWebTarget: (url: string) => `Uloženo u projektu: ${url}`,
      publicUrlWillBeSaved: (name: string) => `Po spuštění se URL uloží k projektu ${name} a příště se předvyplní.`,
      nextStepAddPublicUrl: "Další krok: vložte veřejnou URL této aplikace. Po spuštění ji uložím k projektu.",
      project: "Projekt",
      checks: "Kontroly",
      tools: "Nástroje",
    ...
    command: {
      ...
      exportCodex: "Exportovat balík pro Codex",
  ...
  en: {
    ...
    dashboard: {
      ...
      reportsEvidenceDetail: (ready: number, total: number) => `${ready}/${total} report artifacts are available from the latest run.`,
      projects: "Projects",
    ...
    projects: {
      ...
      publicUrlSaved: (name: string) => `Public URL for ${name} was saved.`,
      publicUrlSaveFailed: "Failed to save the project public URL.",
    ...
    execution: {
      ...
      exportCodexLabel: "Export Codex package",
      exportCodexTitle: "Export redacted Markdown remediation prompt for Codex",
      ...
      reportCenterAria: "Latest scan report center",
      reportRunMissing: "Run or load a scan to create report evidence.",
      markdownReport: "Markdown report",
      jsonReport: "JSON report",
      sarifReport: "SARIF report",
      ...
      reportEvidenceMeta: (root: string, fileName: string) => `${root}/${fileName}`,
      reportEvidenceMissingMeta: "waiting for the next completed run",
    ...
    telemetry: {
      ...
      accessDescription: "STRATOS OIDC, capabilities, and active scopes",
      signIn: "Sign in",
      signOut: "Sign out",
      apiAuthMode: "API authentication mode",
      sharedTokenOrLocal: "shared token or local development",
      rbacRoles: "Identity role diagnostics",
      operatorRoles: (count: number) => `${count} display roles`,
      notLoaded: "not loaded",
    ...
    auth: {
      ...
      accessDeniedTopbar: "SecurityPreflight / No access",
    ...
    messages: {
      ...
      activeProfileSwitchedToWebTarget: "This profile checks a running web app or API. I switched the target to Web/API; enter the application URL and run the scan.",
      activeProfileSwitchedToSavedWebTarget: "This profile checks a running web app or API. I switched the target to Web/API and used the project URL already saved.",
      ...
      codexInitial: "The Codex package is generated from redacted evidence of the latest scan.",
      generatingCodex: "Generating redacted Markdown package for Codex...",
      codexGenerated: (fileName: string) => `Codex package generated: ${fileName}`,
      codexFailed: "Codex package export failed.",
      loadProfilesFallback: "Load profiles from the local API to start scanning."
    },
    newScan: {
      title: "New security check",
      subtitle: "Choose a project directory or allowlisted URL, select a profile, run a plan or scan, and download the remediation handoff for Codex.",
      workflow: "Check workflow",
      workflowDescription: "Target, profile, plan, evidence, and remediation stay in one workflow.",
      noRun: "no run",
      target: "Check target",
      selectedTarget: "Selected target",
      scanComposer: "Configure check",
      scanControl: "Profile and execution",
      projectRegistry: "Register directory",
      projectRegistryDescription: "Manual registration complements automatic /srv and /opt discovery.",
      ...
      lastRun: "status",
      codexPackage: "Codex remediation",
      exportCodex: "Codex package",
      redactedMarkdown: "Redacted Markdown",
      codexMeta: "Prompt, prioritized findings, validation, evidence, and safety boundaries.",
      evidence: "Evidence",
      stepTarget: "1. Target",
      stepProfile: "2. Profile",
      stepPlan: "3. Plan and run",
      stepCodex: "4. Fix in Codex",
      profileChecks: (count: number) => `${count} checks`,
      planPending: "Dry-run plan has not been built yet.",
    ...
    runPanel: {
      ...
      savedWebTarget: (url: string) => `Saved on project: ${url}`,
      publicUrlWillBeSaved: (name: string) => `After running, this URL will be saved to ${name} and prefilled next time.`,
      nextStepAddPublicUrl: "Next step: enter this application's public URL. I will save it to the project after starting.",
      project: "Project",
      checks: "Checks",
      tools: "Tools",
    ...
    command: {
      ...
      exportCodex: "Export Codex package",
